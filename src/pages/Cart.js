...
<div className="first-thisdiv">
  ...
  <div className="inner-seconddiv">
    ...
    <div className="second-colum">
      ...
      <p className="last-price01">&pound;17.99</p>
      </div>
